import os, re, requests, json, uuid
import glob, csv
import pandas as pd
    ...
    def __init__(self, operation, body={}):
        ...
        try:
            ...
            if self.api_key:
                ...
                print("mouser api key not found!")
                return None
        except:
            print("\"MOUSER_API_KEY\" environment variable not found!")
            return None
...
class BOMHandler:
    ...
    target_headers = ["MFN", "Qty", "Reference(s)"] # target headers
    data_array = []
